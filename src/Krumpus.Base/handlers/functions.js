...
module.exports = async (client, reload) => {
	errors = "";
		...
		const functions = readdirSync(`./src/Krumpus.Base/functions/`).filter((f) => f.endsWith(".js")); // Filter files in sub-directories that only .js files would be loaded in to variable
